...
from algoritmoGenetico import algoritmo_genetico,plot,borrar_contenido_carpeta,generarGif
import numpy as np
...
class MainWindow(QWidget): #  Clase para la ventana principal
    def __init__(self): # Constructor de la clase
        ...
        self.myButtonEstadistica = QPushButton("Grafica", self)  # Crea un nuevo botón con el texto "My Button"
        # Establece las propiedades de posición y tamaño
        self.myButtonEstadistica.setGeometry(1090, 360, 161, 51)
        self.myButtonEstadistica.clicked.connect(self.myButtonEstadisticaClicked)
        
        self.myButtonAnimacion = QPushButton("Animación", self)  # Crea un nuevo botón con el texto "My Button"
        # Establece las propiedades de posición y tamaño
        self.myButtonAnimacion.setGeometry(1090, 160, 161, 51)
        self.myButtonAnimacion.clicked.connect(self.myButtonAnimacionClicked)
    ...
    def myButtonAnimacionClicked(self):
        self.genetic_thread.anime()

    def myButtonEstadisticaClicked(self):
        self.genetic_thread.grafica()
...
if __name__ == '__main__': # Función principal
    ...
    borrar_contenido_carpeta("ImagenesGif")
    try: 
